...
or changes :class:`~arc_paper.cached_document.CachedDocumentRef` identity.
"""
...
DOCUMENT_STRUCTURE_OVERLAY_SCHEMA = "arc.paper.document_structure_overlay.v1"
CACHED_DOCUMENT_STRUCTURE_REF_SCHEMA = (
    "arc.paper.cached_document_structure_ref.v1"
)
DOCUMENT_STRUCTURE_CACHE_SCHEMA = "arc.paper.document_structure_cache.v1"
DOCUMENT_STRUCTURE_CONTRACT = (
    "arc.paper.document_structure.qpdf_outline_markdown_alignment.v2"
)
