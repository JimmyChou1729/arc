...
EQUATION_LABEL_VISUAL_PROMPT_VERSION = "arc.paper.equation_label_visual_prompt.v1"
EQUATION_LABEL_PAGE_REVIEW_SCHEMA = "arc.paper.equation_label_page_review.v1"
EQUATION_LABEL_VISUAL_DIAGNOSTIC_SCHEMA = "arc.paper.equation_label_visual_diagnostic.v1"
...
def _manifest_document(
    ...
    return {
        "schema_version": "arc.paper.equation_label_manifest.v1",
