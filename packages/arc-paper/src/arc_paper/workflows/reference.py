...
REFERENCE_PROMPT_CONTRACT = "arc.paper.reference_inference_prompt.v2"
REFERENCE_OUTPUT_CONTRACT = "arc.paper.reference_inference_output.v1"
...
class ReferenceInferenceResult:
    ...
    def to_document(self) -> dict[str, JsonValue]:
        return {
            "schema_version": "arc.paper.reference_inference.v2",
        ...
        *,
        ...
        if explicit_ids:
            verified = _verify_explicit_ids(
                explicit_ids[:2], metadata_lookup=metadata_lookup
            )
...
for a single domain or one for each of the two strongest domains.
